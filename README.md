...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-shape-dcaf
```

A live public deployment of this template is available at [https://rapid-shape-dcaf.templates.workers.dev](https://rapid-shape-dcaf.templates.workers.dev)
